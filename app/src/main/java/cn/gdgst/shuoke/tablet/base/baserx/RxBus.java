...
public class RxBus {
     ...
     * 单例模式中必须要重写默认的构造函数，并且要私有化
     */
    private RxBus() {

    }
    //Subject: 代表的是Observable 和 Observe
    //注解是防止警告的出现  hashMap集合是不同步非线程安全，hashTable同步线程安全，ConcurrentHashTable是hashTable的代替，拓展性比hashTable更好
