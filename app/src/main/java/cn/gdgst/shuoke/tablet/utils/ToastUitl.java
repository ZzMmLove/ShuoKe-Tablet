package cn.gdgst.shuoke.tablet.utils;
...
//		Toast.makeText(context, strResId, Toast.LENGTH_SHORT).show();
    ...
    public static Toast showToastWithImg(final String tvStr, final int imageResource) {
        if (toast2 == null) {
            toast2 = new Toast(AppApplication.getAppContext());
        }
        View view = LayoutInflater.from(AppApplication.getAppContext()).inflate(R.layout.toast_custom, null);
